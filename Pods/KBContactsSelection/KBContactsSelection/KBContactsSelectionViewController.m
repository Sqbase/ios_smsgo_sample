...
{
    NSLog(@"%@", [_kBContactsTableViewDataSource phonesOfSelectedContacts]);
    [[NSNotificationCenter defaultCenter] postNotificationName:@"sendContant" object:[_kBContactsTableViewDataSource phonesOfSelectedContacts]];
